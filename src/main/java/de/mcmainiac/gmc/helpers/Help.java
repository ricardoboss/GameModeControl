	...
	static void Command(CommandSender sender, String command) {
		...
		case "gm":
			Send(sender, new String[]{
				...
				" " + MessageColor.GOLD + "0" + MessageColor.GRAY + ", " + MessageColor.GOLD + "1" + MessageColor.GRAY +
						", " + MessageColor.GOLD + "2" + MessageColor.GRAY + ", " + MessageColor.GOLD + "3" +
						MessageColor.GRAY + ", " + MessageColor.GOLD + "survival" + MessageColor.GRAY + ", " +
