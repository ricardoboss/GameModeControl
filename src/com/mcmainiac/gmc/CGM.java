...
public class CGM {
	...
	public static enum ControlledGameMode {
		...
		public String getName() throws GameModeNotFoundException {
			return this.toString();
		}
		
		public int getId() throws GameModeNotFoundException {
			switch(this) {
		...
		public GameMode getGamemode() throws GameModeNotFoundException {
			switch(this) {
			case SURVIVAL: return GameMode.SURVIVAL;
			case CREATIVE: return GameMode.CREATIVE;
			case ADVENTURE: return GameMode.ADVENTURE;
